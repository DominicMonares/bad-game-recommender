...
describe('Native Tests', () => {
  ...
  it('should render Cover correctly', () => {
    ...
    const coverBR = coverBL['children'][0];
    ...
    const coverTL = coverBR['children'][0];
    ...
    const coverTR = coverTL['children'][0];
    ...
    const cover = coverTR['children'][0];
  ...
  it('should render Rating correctly', () => {
    ...
    expect(rating['children'][0]).toBe('20/100');
  });
  ...
  it('should render PageButtons correctly', () => {
    ...
    const backButton = buttons['children'][0];
    ...
    const backButtonText = backButton['children'][0];
    ...
    expect(backButtonText['children'][0]).toBe('<');

    const button1 = buttons['children'][1];
    ...
    const button1Text = button1['children'][0];
    ...
    expect(button1Text['children'][0]).toBe('1');

    const button2 = buttons['children'][2];
    ...
    const button2Text = button2['children'][0]
    ...
    expect(button2Text['children'][0]).toBe('2');

    const button3 = buttons['children'][3];
    ...
    const button3Text = button3['children'][0]
    ...
    expect(button3Text['children'][0]).toBe('3');

    const button4 = buttons['children'][4];
    ...
    const button4Text = button4['children'][0]
    ...
    expect(button4Text['children'][0]).toBe('4');

    const button5 = buttons['children'][5];
    ...
    const button5Text = button5['children'][0]
    ...
    expect(button5Text['children'][0]).toBe('5');

    const forwardButton = buttons['children'][6];
    ...
    const forwardButtonText = forwardButton['children'][0]
    ...
    expect(forwardButtonText['children'][0]).toBe('>');
  });
  ...
  it('should render the loading wheel when a new page is selected', async () => {
    ...
    await fireEvent.press(getByTestId('page_5'));
